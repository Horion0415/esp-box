...
if(LV_MICROPYTHON)
  ...
  if(CONFIG_LV_USE_DEMO_RENDER)
    file(GLOB_RECURSE DEMO_RENDER_SOURCES ${LVGL_ROOT_DIR}/demos/render/*.c)
    list(APPEND DEMO_SOURCES ${DEMO_RENDER_SOURCES})
  endif()
  if(CONFIG_LV_USE_DEMO_VECTOR_GRAPHIC)
    file(GLOB_RECURSE DEMO_VECTOR_GRAPHIC_SOURCES ${LVGL_ROOT_DIR}/demos/vector_graphic/*.c)
    list(APPEND DEMO_SOURCES ${DEMO_VECTOR_GRAPHIC_SOURCES})
  endif()
